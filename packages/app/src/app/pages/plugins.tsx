      ...
      <div class="bg-gray-2/30 border border-gray-6/50 rounded-2xl p-5 space-y-4">
        <div class="flex items-start justify-between gap-4">
          <div class="space-y-1">
            ...
            <div class="text-xs text-gray-10">{translate("plugins.desc")}</div>
          </div>
        ...
        <div class="space-y-3">
          <div class="text-xs font-medium text-gray-11 uppercase tracking-wider">{translate("plugins.suggested_title")}</div>
                    ...
                    <div class="flex items-start justify-between gap-4">
                      ...
                      <div class="flex items-center gap-2">
                        <Show when={isGuided()}>
                          ...
                          >
                            {isGuideOpen() ? translate("plugins.hide_setup") : translate("plugins.setup_btn")}
                          </Button>
                        </Show>
                        <Button
            ...
            <For each={props.pluginList}>
              {(pluginName) => (
                <div class="flex items-center justify-between rounded-xl border border-gray-6/60 bg-gray-1/40 px-4 py-2.5">
                  ...
                  <div class="flex items-center gap-2">
                    <div class="text-[10px] uppercase tracking-wide text-gray-10">{translate("plugins.enabled_label")}</div>
                    <Button
                      variant="ghost"
        ...
        <div class="flex flex-col gap-3">
          <div class="flex flex-col md:flex-row gap-3">
            <div class="flex-1">
              <TextInput
                label={translate("plugins.add_plugin_label")}
                placeholder={translate("plugins.add_plugin_placeholder")}
                value={props.pluginInput}
                onInput={(e) => props.setPluginInput(e.currentTarget.value)}
                hint={translate("plugins.add_plugin_hint")}
              />
            </div>
            <Button
              variant="secondary"
